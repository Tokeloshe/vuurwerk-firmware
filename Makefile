...
OBJS += ui/ui.o
OBJS += ui/welcome.o
OBJS += ui/vuurwerk_about.o
OBJS += ui/vuurwerk_menu.o
OBJS += version.o
OBJS += main.o
...
OBJS += scanwatch.o
OBJS += squelch.o
OBJS += signal_quality.o
OBJS += tx_compressor.o
OBJS += ctcss_lead.o
OBJS += tx_soft_start.o
OBJS += vfo_split.o
OBJS += bandscope.o
OBJS += rssi_filter.o
OBJS += rssi_histogram.o
OBJS += signal_classifier.o
OBJS += dual_watch_mgmt.o
OBJS += gain_staging.o
OBJS += squelch_tail.o
OBJS += smart_squelch.o
OBJS += side_toast.o
OBJS += toast.o
OBJS += scan_rate.o
OBJS += flashlight_watchdog.o
OBJS += audio_palette.o
OBJS += boot_health.o
OBJS += battery_tx_monitor.o
OBJS += backlight_fade.o
OBJS += battery_sag.o
...
AUTHOR_STRING ?= VUURWERK
VERSION_STRING ?= v1.2.7
