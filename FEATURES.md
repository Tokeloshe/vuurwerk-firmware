...
- **Why it matters:** stock transitions abruptly MAX -> MIN/0 in a single tick; the taper says "tap any key" without requiring the operator to remember the timeout.
...
- **F+* FM-mode gate (MAIN_Key_STAR F-key branch):** post-NOAA,
  ...
  exists for the menu STAR path at `app/menu.c:1611-1615`.
