...
// First-tick cold start uses BSS zero-init: last_frequency[vfo] = 0
// triggers the frequency-change branch on the first call, which
// writes stock gain to REG_13 -- no explicit Init function needed.
